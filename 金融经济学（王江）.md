...
最新版本: https://github.com/Tianyu-Tian/FinancialEconomicsNotes
...
$$
e_{k} \equiv [e_{k,0};e_{k,1}]=[e_{k,0};[e_{k,11},...,e_{k,1\omega},...,e_{k,1\Omega}]]
$$
...
$$
c_{k} \equiv [c_{k,0};c_{k,1}]=[e_{k,0};[c_{k,11},...,c_{k,1\omega},...,c_{k,1\Omega}]]
$$
...
定理3.2$\quad$假定$DU \gg 0$，那么优化问题的解满足：
$$
